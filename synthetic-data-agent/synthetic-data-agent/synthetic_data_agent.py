    ...
    def generate_customer_data(self, num_records: int) -> pd.DataFrame:
        ...
        for _ in range(num_records):
            customers.append({
                ...
                #For is_active (80% True, 20% False)
        ...
        for platform_id in range(1, num_platforms + 1):
            ...
            for item_id in range(1, num_items + 1):
                ...
                equipment_data.append({
                    ...
                    'item_type': random.choice(['Hardware', 'Software', 'Testing', 'Integration', 'Documentation'])[0],
                    ...
                    'priority': random.choice(['High', 'Medium', 'Medium', 'High', 'Low']), #60% Medium, 20% High, 20% Low
